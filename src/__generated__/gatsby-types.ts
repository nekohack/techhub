...
type File = Node & {
  ...
  readonly children: ReadonlyArray<Node>;
  readonly internal: Internal;
  readonly childrenSitesYaml: Maybe<ReadonlyArray<Maybe<SitesYaml>>>;
};
...
enum FileFieldsEnum {
  ...
  internal___owner = 'internal.owner',
  internal___type = 'internal.type',
  childrenSitesYaml = 'childrenSitesYaml',
  childrenSitesYaml___id = 'childrenSitesYaml.id',
  childrenSitesYaml___parent___id = 'childrenSitesYaml.parent.id',
  childrenSitesYaml___parent___parent___id = 'childrenSitesYaml.parent.parent.id',
  childrenSitesYaml___parent___parent___children = 'childrenSitesYaml.parent.parent.children',
  childrenSitesYaml___parent___children = 'childrenSitesYaml.parent.children',
  childrenSitesYaml___parent___children___id = 'childrenSitesYaml.parent.children.id',
  childrenSitesYaml___parent___children___children = 'childrenSitesYaml.parent.children.children',
  childrenSitesYaml___parent___internal___content = 'childrenSitesYaml.parent.internal.content',
  childrenSitesYaml___parent___internal___contentDigest = 'childrenSitesYaml.parent.internal.contentDigest',
  childrenSitesYaml___parent___internal___description = 'childrenSitesYaml.parent.internal.description',
  childrenSitesYaml___parent___internal___fieldOwners = 'childrenSitesYaml.parent.internal.fieldOwners',
  childrenSitesYaml___parent___internal___ignoreType = 'childrenSitesYaml.parent.internal.ignoreType',
  childrenSitesYaml___parent___internal___mediaType = 'childrenSitesYaml.parent.internal.mediaType',
  childrenSitesYaml___parent___internal___owner = 'childrenSitesYaml.parent.internal.owner',
  childrenSitesYaml___parent___internal___type = 'childrenSitesYaml.parent.internal.type',
  childrenSitesYaml___children = 'childrenSitesYaml.children',
  childrenSitesYaml___children___id = 'childrenSitesYaml.children.id',
  childrenSitesYaml___children___parent___id = 'childrenSitesYaml.children.parent.id',
  childrenSitesYaml___children___parent___children = 'childrenSitesYaml.children.parent.children',
  childrenSitesYaml___children___children = 'childrenSitesYaml.children.children',
  childrenSitesYaml___children___children___id = 'childrenSitesYaml.children.children.id',
  childrenSitesYaml___children___children___children = 'childrenSitesYaml.children.children.children',
  childrenSitesYaml___children___internal___content = 'childrenSitesYaml.children.internal.content',
  childrenSitesYaml___children___internal___contentDigest = 'childrenSitesYaml.children.internal.contentDigest',
  childrenSitesYaml___children___internal___description = 'childrenSitesYaml.children.internal.description',
  childrenSitesYaml___children___internal___fieldOwners = 'childrenSitesYaml.children.internal.fieldOwners',
  childrenSitesYaml___children___internal___ignoreType = 'childrenSitesYaml.children.internal.ignoreType',
  childrenSitesYaml___children___internal___mediaType = 'childrenSitesYaml.children.internal.mediaType',
  childrenSitesYaml___children___internal___owner = 'childrenSitesYaml.children.internal.owner',
  childrenSitesYaml___children___internal___type = 'childrenSitesYaml.children.internal.type',
  childrenSitesYaml___internal___content = 'childrenSitesYaml.internal.content',
  childrenSitesYaml___internal___contentDigest = 'childrenSitesYaml.internal.contentDigest',
  childrenSitesYaml___internal___description = 'childrenSitesYaml.internal.description',
  childrenSitesYaml___internal___fieldOwners = 'childrenSitesYaml.internal.fieldOwners',
  childrenSitesYaml___internal___ignoreType = 'childrenSitesYaml.internal.ignoreType',
  childrenSitesYaml___internal___mediaType = 'childrenSitesYaml.internal.mediaType',
  childrenSitesYaml___internal___owner = 'childrenSitesYaml.internal.owner',
  childrenSitesYaml___internal___type = 'childrenSitesYaml.internal.type',
  childrenSitesYaml___name = 'childrenSitesYaml.name',
  childrenSitesYaml___imageName = 'childrenSitesYaml.imageName',
  childrenSitesYaml___url = 'childrenSitesYaml.url',
  childrenSitesYaml___type = 'childrenSitesYaml.type'
}
...
type FileFilterInput = {
  ...
  readonly children: Maybe<NodeFilterListInput>;
  readonly internal: Maybe<InternalFilterInput>;
  readonly childrenSitesYaml: Maybe<SitesYamlFilterListInput>;
};
...
type Query = {
  ...
  readonly sitesYaml: Maybe<SitesYaml>;
  readonly allSitesYaml: SitesYamlConnection;
...
type Query_fileArgs = {
  ...
  childrenSitesYaml: Maybe<SitesYamlFilterListInput>;
};
...
type Query_sitesYamlArgs = {
  id: Maybe<StringQueryOperatorInput>;
  parent: Maybe<NodeFilterInput>;
  children: Maybe<NodeFilterListInput>;
  internal: Maybe<InternalFilterInput>;
  name: Maybe<StringQueryOperatorInput>;
  imageName: Maybe<StringQueryOperatorInput>;
  url: Maybe<StringQueryOperatorInput>;
  type: Maybe<StringQueryOperatorInput>;
};


type Query_allSitesYamlArgs = {
  filter: Maybe<SitesYamlFilterInput>;
  sort: Maybe<SitesYamlSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type SitesYamlConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<SitesYamlEdge>;
  readonly nodes: ReadonlyArray<SitesYaml>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly group: ReadonlyArray<SitesYamlGroupConnection>;
};


type SitesYamlConnection_distinctArgs = {
  field: SitesYamlFieldsEnum;
};


type SitesYamlConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: SitesYamlFieldsEnum;
};
...
type SitesYamlEdge = {
  readonly next: Maybe<SitesYaml>;
  readonly node: SitesYaml;
  readonly previous: Maybe<SitesYaml>;
};

enum SitesYamlFieldsEnum {
  id = 'id',
  parent___id = 'parent.id',
  parent___parent___id = 'parent.parent.id',
  parent___parent___parent___id = 'parent.parent.parent.id',
...
type SitesYamlFilterInput = {
  readonly id: Maybe<StringQueryOperatorInput>;
  readonly parent: Maybe<NodeFilterInput>;
  readonly children: Maybe<NodeFilterListInput>;
  readonly internal: Maybe<InternalFilterInput>;
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly imageName: Maybe<StringQueryOperatorInput>;
  readonly url: Maybe<StringQueryOperatorInput>;
  readonly type: Maybe<StringQueryOperatorInput>;
};

type SitesYamlFilterListInput = {
  readonly elemMatch: Maybe<SitesYamlFilterInput>;
};

type SitesYamlGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<SitesYamlEdge>;
  readonly nodes: ReadonlyArray<SitesYaml>;
  readonly pageInfo: PageInfo;
...
type SitesYamlSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<SitesYamlFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type Unnamed_1_Query = { readonly file: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }> };

type SEOQueryVariables = Exact<{ [key: string]: never; }>;


type SEOQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'titleTemplate' | 'description' | 'siteUrl' | 'image'>> }> };
...
type SiteTitleQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'locale'>> }>, readonly blogImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, readonly performanceImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, readonly routineImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, readonly bakenekoImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, readonly allSitesYaml: { readonly edges: ReadonlyArray<{ readonly node: Pick<SitesYaml, 'id' | 'name' | 'imageName' | 'url' | 'type'> }> } };
